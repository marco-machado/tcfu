...
| id | name | unlock_score | move_mult | hitbox_r | hp_per_life | start_bombs | weapon_id | passive_id | blurb |
|----|------|--------------|-----------|----------|-------------|-------------|-----------|------------|-------|
| vanguard | Vanguard | 0 | 1.0 | 0.35 | 3 | 2 | pulse_cannon | none | Reliable frontline interceptor. Tuning baseline. |
| striker | Striker | 25000 | 1.15 | 0.32 | 2 | 2 | twin_lance | dmg_10 | Hot rod gunship. Higher DPS, glass hull. |
| aegis | Aegis | 75000 | 0.9 | 0.38 | 3 | 3 | wide_pulse | start_shield | Armored wing. Survives messy patterns. |
| phantom | Phantom | 150000 | 1.25 | 0.28 | 3 | 2 | needle | iframe_bonus | Ghost interceptor. Dance the band. |
